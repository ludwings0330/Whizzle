...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_rr90o88kt0wlpqgonwwxphpko` (`saved_path`)
...
DROP TABLE IF EXISTS `member_has_badge`;
CREATE TABLE `member_has_badge` (
  ...
  CONSTRAINT `fk_badge` FOREIGN KEY (`badge_id`) REFERENCES `badge` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_member` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `whisky` (
  ...
  `url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_t0uupn9ptgs491vqjrpuxbbsr` (`saved_path`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `diary` (
  ...
  `modified_date_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK4uk9o366grmoq9hf6t72d8vi` (`member_id`,`created_date_time`),
...
CREATE TABLE `review_image` (
  ...
  `is_deleted` bit(1) NOT NULL DEFAULT b'0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_snj3cydk6j7iwg725ik2vkrl8` (`saved_path`),
